...
8. [Infraestructura y Despliegue en la Nube](#-infraestructura-y-despliegue-en-la-nube)
   ...
   - [Frontend en Vercel (SPA)](#frontend-en-vercel-spa)
...
| **Frontend SPA** | [Vercel](https://vercel.com) / [Netlify](https://netlify.com) | Red Global Edge CDN con CI/CD automatizado desde GitHub |
...
* **Variables de Entorno en Vercel:**
  * `VITE_API_URL`: URL pública de la API con sufijo `/api` (ej. `https://patilladash-api.onrender.com/api`).
* **Enrutamiento SPA y Cabeceras de Seguridad:** Gestionadas vía ficheros [`vercel.json`](file:///home/edgardopacheco/EDGARDO%20PACHECO/RiderProjects/PatillaDash/vercel.json) con rewrites automáticos hacia `index.html` para evitar errores 404 en rutas internas de React Router.
